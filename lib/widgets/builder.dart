...
class AnimatedFutureBuilder<T> extends StatefulWidget {
  ...
  @override
  State<AnimatedFutureBuilder<T>> createState() => _AnimatedFutureBuilderState<T>();
}

/// State for [AnimatedFutureBuilder].
class _AnimatedFutureBuilderState<T> extends State<AnimatedFutureBuilder<T>> {
  ...
  @override
  void didUpdateWidget(AnimatedFutureBuilder<T> oldWidget) {
  ...
  @override
  Widget build(BuildContext context) => AnimatedSwitcher(duration: widget.duration, transitionBuilder: widget.transitionBuilder, child: widget.builder(context, _snapshot));
